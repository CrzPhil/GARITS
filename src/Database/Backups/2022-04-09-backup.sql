...
CREATE TABLE `CompletedJobs` (
  ...
  `requiredParts` varchar(255) DEFAULT NULL,
...
CREATE TABLE `Jobs` (
  ...
  `mileage` int DEFAULT NULL,
  `price` float DEFAULT NULL,
  `requiredParts` varchar(500) DEFAULT NULL,
  `additionalInfo` varchar(500) DEFAULT NULL,
  `status` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`jobID`)
...
INSERT INTO `Jobs` VALUES (1,'MOT',156,'23/03/22','Bulb','8161561',51261,12.65,'Bulb','',NULL),(2,'MOT',200,'08/04/2022','Grommet','E120SD92BA',80873,69,'Grommet','Testing additional details.',NULL),(3,'MOT',50,'12.01.2022','','EC1AASF23',12314,70,'','Took extra long;\nDouble cost;\nEtc.',NULL);
...
CREATE TABLE `Staff` (
  ...
  PRIMARY KEY (`staffID`)
) ENGINE=InnoDB AUTO_INCREMENT=1574527223 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Staff` VALUES (1574527208,'Penelope','Carr','Receptionist','Penelope','56DFFC22BD487CF69C74DA553ACC60DE6C60CAB2AB41A0BCCC4AD1AE6E614583',150,'penelope.carr@gmail.com'),(1574527209,'Sunny','Evans','Foreman','Sunny','B43CCB6B3EA7DCB81D90C7510AA44D3E7782F77CABDDF02B30C44EDAEFF708C2',125,'sunny.evans@gmail.com'),(1574527210,'Glynne','Lancaster','Franchisee','Glynne','C134547585F40BF1516F5F1D01039F7E275DD10DB503D891F292F9CD246B0263',125,'glynne.lancaster@gmail.com'),(1574527211,'Administrator','Role','Administrator','SYSDBA','1100FD026BF3B5B6EBD6B4B37D67F3D44B22A11ACFB0F506DBA2AAB159708F56',200,NULL),(1574527213,'Gavin','Ross','Mechanic','Gavin','B26C4976AADC25DBF5C57D708A5567D83F40C1260C34C2676E749C52BB5427F9',105,'gavin.ross@gmail.com'),(1574527214,'Anthony','Wild','Mechanic','Anthony','522D20AAA1FE0A723459DB33367378D30ECA34E727CF0AF50372F478CB285329',105,'anthony.wild@gmail.com'),(1574527222,'a','a','Receptionist','admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',1,'admin@admin.com');
...
-- Dump completed on 2022-04-09 21:00:05
