...
) ENGINE=InnoDB AUTO_INCREMENT=1234567901 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Customers` VALUES (1234567893,'Johnny','Knoxville','11 Utter street, London','+44 4444444444','jay@knox.com','1234567891',10),(1234567894,'Jimmy','Slim','Fatlane 33, EC1V 3AQ, London, United Kingdom','+22 43445444443','Jay@slim.com','1234566780',123),(1234567895,'Adam','Stone','1 Marzook Close','08974651','asdasd@gmail.com','',0),(1234567896,'Transco','Gas','Methane Buildings, Sulphur Lane, Stenchville, Bucks, HP19 2MT','01949683725','empoty@empty.com','',0),(1234567898,'Joane','Ripley','14 Address Avenue','0214801212','addddd@as.asc','',1);
...
INSERT INTO `Job_SpareParts` VALUES (36,'D43-78',26),(27,'M01L',50),(43,'G457',53),(43,'SPPL-UGS',54);
...
CREATE TABLE `Jobs` (
  ...
  CONSTRAINT `Jobs_ibfk_2` FOREIGN KEY (`registrationNo`) REFERENCES `Vehicles` (`registrationNo`) ON DELETE CASCADE
...
INSERT INTO `Jobs` VALUES (27,'MOT',5.5,'Thu Apr 21 23:38:38 BST 2022','',545421,25.00,'Changed Bulb, \nAdded Oil,\nDid things',1,'EC1V3GG',1574527214),(29,'Service',2,'Fri Apr 15 00:00:00 BST 2022','6512651',65263,100.00,'',1,'fe33 jmm',1574527231),(36,'Service',5.5,'Sat Apr 16 00:00:00 BST 2022','21651651',61516,25.00,'',0,'ff60 knf',1574527214),(43,'Service',1,'Fri Apr 15 10:11:59 BST 2022','',5000,50.00,'Changed Spark Plugs, Changed water pump',1,'ff60 knf',1574527214);
...
INSERT INTO `SpareParts` VALUES ('BULB-INT','Interior Bulb','Rolls Royce','Gen 1',2002,2,1,118),('D43-78','Grommet','Vauxhill','Ofcorsa',2020,12,1.3,5),('EM4LL-3GC','Engine Mount set ','All','All',2018,19,15,4),('EX-H4U','Exhaust, complete box','Fjord','Estate',1998,0,200,2),('G457','Water Pump','Fjord','Krapa',2014,7,56.7,5),('H456-9UI','Water Pump','Volva','S34',2008,0,124.34,5),('M01L','Motor Oil','All','All',0,29,25,25),('NEWPART','NEW','Fjord','Transit Van',2020,5,130,20),('PR3D','Paint, Arrogant Red','All','All',0,3,2,60),('SPPL-UGS','Spark Plugs','All','All',2017,24,1.5,20),('TY-R3','Heavy tread tyre','Fjord','Transit Van',2011,7,45,6),('X66745877','Grommet','Fjord','Krapa',2014,16,1.9,5),('X784/6352J','Exhaust Pipe','Ford','Focus',2014,5,1.9,5),('Y76432-89T5','Head Gasket','Nissan','Elgrand',2012,5,69.99,5);
...
CREATE TABLE `Staff` (
  ...
  PRIMARY KEY (`staffID`)
) ENGINE=InnoDB AUTO_INCREMENT=1574527238 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Staff` VALUES (1574527208,'Penelope','Carr','Receptionist','Penelope','56dffc22bd487cf69c74da553acc60de6c60cab2ab41a0bccc4ad1ae6e614583',105,'penelopecarr@garits.org.uk'),(1574527211,'Administrator','Role','Administrator','SYSDBA','1100FD026BF3B5B6EBD6B4B37D67F3D44B22A11ACFB0F506DBA2AAB159708F56',200,NULL),(1574527214,'Anthony','Wild','Mechanic','Anthony','522D20AAA1FE0A723459DB33367378D30ECA34E727CF0AF50372F478CB285329',105,'anthonywild@garits.org.uk'),(1574527223,'Changes','Work','','admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',123,'asdf@delete.mepliz'),(1574527231,'Gavin','Ross','Mechanic','Gavin','b26c4976aadc25dbf5c57d708a5567d83f40c1260c34c2676e749c52bb5427f9',105,'gavinross@garits.org.uk'),(1574527235,'Sunny','Evans','Foreperson','Sunny','b43ccb6b3ea7dcb81d90c7510aa44d3e7782f77cabddf02b30c44edaeff708c2',125,'sunnyevans@garits.org.uk'),(1574527236,'Glynne','Lancaster','Franchisee','Glynne','c134547585f40bf1516f5f1d01039f7e275dd10db503d891f292f9cd246b0263',1,'glynne.lancaster@hotmail.com'),(1574527237,'New','Mechanic','Mechanic','newmech','157553300c3918b1ab98e1045705851e48a5415c32a51e0d7bf44763242799ed',120,'new@mech.com');
...
CREATE TABLE `Vehicles` (
  ...
  `engSerial` varchar(255) DEFAULT NULL,
...
INSERT INTO `Vehicles` VALUES ('AA69 CPG','Fjord','Transit Van','','','White','2019-12-05',1234567896),('CT70 DWR','Fjord','Transit Van','','','White','2020-12-12',1234567896),('EC1V3GG','sMercedes','AMG','E123123','E123128','Black','2020-01-11',1234567894),('fe33 jmm','Toyota','Avensus','sd2651','sd1651','Black','2022-04-12',1234567895),('ff60 knf','Mercedes','AMG','1321EASE','EASED123123','Black','2002-11-12',1234567893),('L55CEJ','Peugeot','208','125124124','352152523','White','2022-11-12',1234567898);
...
-- Dump completed on 2022-04-14 10:43:42
