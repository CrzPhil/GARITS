...
CREATE TABLE `Job_SpareParts` (
  ...
  CONSTRAINT `Job_SpareParts_ibfk_3` FOREIGN KEY (`jobID`) REFERENCES `Jobs` (`jobID`)
...
INSERT INTO `Jobs` VALUES (24,'MOT',1234,'Fri Apr 29 22:07:32 BST 2022','','',54555,1234.00,'',0,'EC1V3GG'),(25,'Repair',345534,'Thu Apr 28 22:08:03 BST 2022','','',78634523,213.00,'',1,'EC1V3GG');
...
INSERT INTO `SpareParts` VALUES ('D43-78','Grommet','Vauxhill','Ofcorsa',2010,2,1.3,0),('G457','Water Pump','Fjord','Krapa',2014,6,56.7,0),('H456-9UI','Water Pump','Volva','S34',2008,1,124.34,0),('X66745877','Grommet','Fjord','Krapa',2014,16,1.9,0),('X784/6352J','Exhaust Pipe','Ford','Focus',2014,6,1.9,0),('Y76432-89T5','Head Gasket','Nissan','Elgrand',2012,6,69.99,0);
...
CREATE TABLE `Staff` (
  ...
  PRIMARY KEY (`staffID`)
) ENGINE=InnoDB AUTO_INCREMENT=1574527231 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Staff` VALUES (1574527208,'Penelope','Carr','Receptionist','Penelope','56DFFC22BD487CF69C74DA553ACC60DE6C60CAB2AB41A0BCCC4AD1AE6E614583',150,'penelope.carr@gmail.com'),(1574527209,'Sunny','Evans','Foreman','Sunny','B43CCB6B3EA7DCB81D90C7510AA44D3E7782F77CABDDF02B30C44EDAEFF708C2',125,'sunny.evans@gmail.com'),(1574527210,'Glynne','Lancaster','Franchisee','Glynne','C134547585F40BF1516F5F1D01039F7E275DD10DB503D891F292F9CD246B0263',NULL,'glynne.lancaster@gmail.com'),(1574527211,'Administrator','Role','Administrator','SYSDBA','1100FD026BF3B5B6EBD6B4B37D67F3D44B22A11ACFB0F506DBA2AAB159708F56',200,NULL),(1574527214,'Anthony','Wild','Mechanic','Anthony','522D20AAA1FE0A723459DB33367378D30ECA34E727CF0AF50372F478CB285329',123,'anthony.wild@gmail.com'),(1574527223,'Changes','Work','','admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',123,'asdf@delete.mepliz'),(1574527226,'Testing','Tester','Receptionist','Tester','c1c224b03cd9bc7b6a86d77f5dace40191766c485cd55dc48caf9ac873335d6f',12,'test@tester.com'),(1574527230,'','','Foreperson','DeleteTest','e7d8ccd805a78737f3b7904df3217d2a473cbdee698a90f14443018e1a0fc925',10,'faf@faf.com');
...
-- Dump completed on 2022-04-12 22:18:31
