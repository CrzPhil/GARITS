...
INSERT INTO `CompletedJobs` VALUES (3,'MOT',50,'12/01/2022','','EC1AASF23',12314,70,'',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=1234567894 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Customers` VALUES (1234567891,'Bobby','Marley','Oval Road 12, Camden Town','071723123','bob.marley@hoax.com','123121324',NULL),(1234567893,'Johnny','Knoxville','11 Utter street, London','+44 4444444444','jay@knox.com','1234567891',123);
...
INSERT INTO `Jobs` VALUES (1,'MOT',156,'23/03/22','Bulb','8161561',51261,12.66,'',0),(2,'MOT',200,'08/04/2022','Grommet','',80873,80.12,'',0),(5,'MOT',155,'22/2/22','','54151561',14915,152.00,'',0);
...
--
-- Table structure for table `Report_SpareParts`
--

DROP TABLE IF EXISTS `Report_SpareParts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Report_SpareParts` (
  `ReportreportID` int NOT NULL,
  `SparePartscode` varchar(255) NOT NULL,
  PRIMARY KEY (`ReportreportID`,`SparePartscode`),
  KEY `FKReport_Spa947610` (`SparePartscode`),
  CONSTRAINT `FKReport_Spa137669` FOREIGN KEY (`ReportreportID`) REFERENCES `Report` (`reportID`),
  CONSTRAINT `FKReport_Spa947610` FOREIGN KEY (`SparePartscode`) REFERENCES `SpareParts` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Report_SpareParts`
--

LOCK TABLES `Report_SpareParts` WRITE;
/*!40000 ALTER TABLE `Report_SpareParts` DISABLE KEYS */;
/*!40000 ALTER TABLE `Report_SpareParts` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `SpareParts` VALUES ('D43-78','Grommet','Vauxhill','Ofcorsa',2010,12,1.3),('G457','Water Pump','Fjord','Krapa',2014,8,56.7),('H456-9UI','Water Pump','Volva','S34',2008,2,124.34),('X66745877','Grommet','Fjord','Krapa',2014,32,1.9),('X784/6352J','Exhaust Pipe','Ford','Focus',2014,8,1.9),('Y76432-89T5','Head Gasket','Nissan','Elgrand',2012,12,69.99);
...
CREATE TABLE `Staff` (
  ...
  PRIMARY KEY (`staffID`)
) ENGINE=InnoDB AUTO_INCREMENT=1574527225 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Staff` VALUES (1574527208,'Penelope','Carr','Receptionist','Penelope','56DFFC22BD487CF69C74DA553ACC60DE6C60CAB2AB41A0BCCC4AD1AE6E614583',150,'penelope.carr@gmail.com'),(1574527209,'Sunny','Evans','Foreman','Sunny','B43CCB6B3EA7DCB81D90C7510AA44D3E7782F77CABDDF02B30C44EDAEFF708C2',125,'sunny.evans@gmail.com'),(1574527210,'Glynne','Lancaster','Franchisee','Glynne','C134547585F40BF1516F5F1D01039F7E275DD10DB503D891F292F9CD246B0263',125,'glynne.lancaster@gmail.com'),(1574527211,'Administrator','Role','Administrator','SYSDBA','1100FD026BF3B5B6EBD6B4B37D67F3D44B22A11ACFB0F506DBA2AAB159708F56',200,NULL),(1574527214,'Anthony','Wild','Mechanic','Anthony','522D20AAA1FE0A723459DB33367378D30ECA34E727CF0AF50372F478CB285329',105,'anthony.wild@gmail.com'),(1574527223,'dontdeletemeplease','dontdoit','Receptionist','admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',1,'dont@delete.mepliz'),(1574527224,'deletewhenpossible','deletewhenpossible','Foreperson','deletewhenpossible','f940cf34ae0778ed138a2f3c4641b8b984033a242b8da16f70b24d9f83ac7649',10,'fafa@gmail.com');
...
INSERT INTO `Vehicles` VALUES ('AX68 ZJG','Ford','Focus','812381283123J','X323124','Pink','2020-03-19',1234567891),('BBBB','Mercedes','AMG','1321EASE','EASED123123','Black','2002-01-01',1234567893),('EX68 ZJG','Ford','Focus','819765237J','X3246751','Pink','2022-01-01',1234567891),('KN09 KLJ','Ford','Mondeo','457863806','23517867','Red','2020-03-30',1234567891),('TT11 OPI','Ford','Mondeo','567437965','34672876','Red','2022-01-02',1234567891),('WR68 SAY','Ford','Mondeo','769342653','76354248','Red','2020-02-10',1234567891);
...
-- Dump completed on 2022-04-11 16:36:35
